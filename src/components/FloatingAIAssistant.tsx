    ...
    <>
      ...
      >
        <div className="relative">
          {/* Botão principal */}
          <div className="w-14 h-14 rounded-full shadow-lg flex items-center justify-center text-white hover:shadow-xl transition-all duration-300" style={{ backgroundColor: '#8B5CF6' }}>
